...
const moveSnake = gameData => {
  ...
  const food = gameData.food.data.filter(function(point) {
  ...
  const path = finder.findPath(myHead.x, myHead.y, nearestFood[0][0], nearestFood[0][1], grid) || null;
